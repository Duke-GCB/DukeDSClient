...
D4S2_SERVICE_URL = 'https://d4s2.gcb.duke.edu/api/v1'
MB_TO_BYTES = 1024 * 1024
DDS_DEFAULT_UPLOAD_CHUNK_SIZE = 100 * MB_TO_BYTES
...
class Config(object):
    ...
    def upload_bytes_per_chunk(self):
        ...
        """
        value = self.values.get(Config.UPLOAD_BYTES_PER_CHUNK, DDS_DEFAULT_UPLOAD_CHUNK_SIZE)
