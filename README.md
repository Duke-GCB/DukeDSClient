...
This token identifies you with the service, and can be generated by visiting the [Duke Data Service API Explorer](https://api.dataservice.duke.edu/apiexplorer).
